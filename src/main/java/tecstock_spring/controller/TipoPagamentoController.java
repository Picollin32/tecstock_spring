...
public class TipoPagamentoController {
    ...
    public TipoPagamento salvar(@RequestBody TipoPagamento tipoPagamento) {
    ...
    public TipoPagamento atualizar(@PathVariable Long id, @RequestBody TipoPagamento tipoPagamento) {
        logger.info("Atualizando tipo de pagamento no controller. ID: " + id + ", Tipo de pagamento: " + tipoPagamento);
        return service.atualizar(id, tipoPagamento);
    }
