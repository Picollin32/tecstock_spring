...
public interface TipoPagamentoRepository extends JpaRepository<TipoPagamento, Long> {
    ...
    @Query("SELECT new tecstock_spring.dto.TipoPagamentoPesquisaDTO(t.id, t.nome, t.codigo, t.idFormaPagamento, t.quantidadeParcelas, t.diasEntreParcelas, t.createdAt, t.updatedAt) FROM TipoPagamento t WHERE t.empresa.id = :empresaId AND LOWER(t.nome) LIKE LOWER(CONCAT(:query, '%'))")
    ...
    @Query("SELECT new tecstock_spring.dto.TipoPagamentoPesquisaDTO(t.id, t.nome, t.codigo, t.idFormaPagamento, t.quantidadeParcelas, t.diasEntreParcelas, t.createdAt, t.updatedAt) FROM TipoPagamento t WHERE t.empresa.id = :empresaId")
    ...
    @Query("SELECT new tecstock_spring.dto.TipoPagamentoPesquisaDTO(t.id, t.nome, t.codigo, t.idFormaPagamento, t.quantidadeParcelas, t.diasEntreParcelas, t.createdAt, t.updatedAt) FROM TipoPagamento t WHERE t.empresa.id = :empresaId ORDER BY t.createdAt DESC")
