...
public interface FornecedorRepository extends JpaRepository<Fornecedor, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT new tecstock_spring.dto.FornecedorPesquisaDTO(f.id, f.nome, f.cnpj, f.telefone, f.email, f.margemLucro, f.rua, f.numeroCasa, f.complemento, f.bairro, f.cidade, f.uf, f.cep, f.codigoMunicipio, f.createdAt, f.updatedAt) FROM Fornecedor f WHERE f.empresa.id = :empresaId AND (LOWER(f.nome) LIKE LOWER(CONCAT(:query, '%')) OR f.cnpj LIKE CONCAT(:query, '%'))")
    ...
    @org.springframework.data.jpa.repository.Query("SELECT new tecstock_spring.dto.FornecedorPesquisaDTO(f.id, f.nome, f.cnpj, f.telefone, f.email, f.margemLucro, f.rua, f.numeroCasa, f.complemento, f.bairro, f.cidade, f.uf, f.cep, f.codigoMunicipio, f.createdAt, f.updatedAt) FROM Fornecedor f WHERE f.empresa.id = :empresaId")
